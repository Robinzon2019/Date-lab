...
- Name: stopwatch.spec.js >> Cronómetro >> inicia, avanza y se puede pausar
- Location: e2e\tests\stopwatch.spec.js:9:3
...
- generic [ref=f1e3]:
  ...
  - navigation "Secciones de Date Lab" [ref=f1e8]:
    ...
    - tab "Cronómetro" [selected] [ref=f1e11] [cursor=pointer]
