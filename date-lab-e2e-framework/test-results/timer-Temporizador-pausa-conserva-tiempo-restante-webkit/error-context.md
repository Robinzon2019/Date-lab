...
- Name: timer.spec.js >> Temporizador >> pausa conserva tiempo restante
- Location: e2e\tests\timer.spec.js:21:3
...
```yaml
- generic [ref=f1e3]:
  - link "Saltar al contenido" [ref=f1e4]:
    - /url: "#contenido"
  - banner [ref=f1e5]:
      ...
      - generic [ref=f1e18]:
        - generic [ref=f1e19]:
          ...
          - generic [ref=f1e26]:
            ...
            - spinbutton "Segundos" [ref=f1e28]: "8"
        - paragraph [ref=f1e29]: 00:00:08
        - paragraph [ref=f1e30]: Temporizador en 00:00:08
        - generic [ref=f1e31]:
          - button "Iniciar" [ref=f1e32] [cursor=pointer]
          - button "Reiniciar" [ref=f1e33] [cursor=pointer]
